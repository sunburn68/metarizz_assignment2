...
class EHadithBooksListPopupDarkScreen extends StatelessWidget {
  const EHadithBooksListPopupDarkScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
            ...
            body: SizedBox(
                ...
                child: Column(children: [
                  SizedBox(height: 5.v),
                  _buildEnglishStack(context),
                  SizedBox(height: 38.v),
                  _buildFiftySevenRow(context),
  ...
  /// Section Widget
  Widget _buildEnglishStack(BuildContext context) {
    return SizedBox(
        height: 372.v,
        width: 352.h,
        child: Stack(alignment: Alignment.bottomLeft, children: [
          Align(
              ...
              child: Padding(
                  padding: EdgeInsets.only(left: 26.h, top: 21.v, right: 35.h),
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    Text("Sahih Al-Bukhari",
                        style: CustomTextStyles.titleSmallTealA10001),
                                      ...
                                      children: [
                                        Padding(
                                            ...
                                            child: _buildVolumeCounter(context,
                                                volumeCounter: "Volume 08",
                                                bookCounter: "Book 08",
                                                hadithCounter: "Hadith 08")),
                                        SizedBox(height: 2.v),
                                        Row(
                                            mainAxisAlignment:
  ...
  /// Section Widget
  Widget _buildFiftySevenRow(BuildContext context) {
    return Padding(
